    ...
    client.on(Discord.Events.InteractionCreate, async (interaction) => {
        ...
        if (interaction.customId == "Bot-helppanel") {
            if (interaction.values == "commands-Bothelp") {
                ...
                client.embed({
                    title: `❓・Help panel`,
                    desc: `View all command categories in the bot here! \n\n[Website](https://axyl.online) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/798144456528363550/vote)`,
                    ...
                    collector.on('collect', async i => {
                        if (i.customId == "helpNext") {
                            ...
                            if (page == 2) {
                                client.embed({
                                    title: `❓・Help panel`,
                                    desc: `View all command categories in the bot here! \n\n[Website](axyl.online) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/798144456528363550/vote)`,
                                    fields: fields.slice(0, 24),
                                    components: [row2, row],
                                    type: 'update'
                                }, i)
