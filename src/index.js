...
axios.get('https://api.github.com/repos/BestGamersH/Multipurpose-Discord-Bot-Second/releases/latest').then(res => {
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© Axyl | 2022 - ${new Date().getFullYear()}`))
